...
const JSLI=((window,factory)=>{
    ...
    constructor(scopes,NSext){
        ...
        TypeConstruct:(obj)=>{
            const TemplateClass=class{
                constructor(...a){
                    const thisObj=obj.call;
                    thisObj["$T"]="TypeConstruct";
                    return new Proxy(thisObj,{
                        construct:obj.constructor?obj.construct:null,
                        set:(...a)=>obj.set?obj.set(...a):void null,
                        get:(...a)=>obj.set?obj.get(...a):void null
                    })
                }
            }
        ...
        Dir:obj=>{
          ...
          for(key in obj){
            const deepkeys=window.$JSL.Dir(obj[key])
            if(deepkeys.length==1){
              dir.push(key,deepkeys)
            }
