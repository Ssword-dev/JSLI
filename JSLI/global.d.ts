...
declare namespace operator {
     ...
     */
    declare function ut(fun:Function,expected:AnyReturnType,...args:any[]):AnyReturnType
    /**
...
declare namespace DOMJSL{
    ...
    * Allows the accessing of each element and applies @param style; to the element
     */
    declare function forEach(selector:string,fun:(elem:HTMLElement,index:number)=>void):void
    /**
     ...
     */
    declare function create<K extends keyof HTMLElementTagNameMap>(className:str,idName:str,tagName:K,innerText):HTMLElement|Node
    /**
     * Fills the parent with cloned children
     */
    declare function fill(element:Node|HTMLElement,parent:Node|HTMLElement,cnt:number):void
}
/**
...
declare namespace WindowBrowser {
     ...
     */
    declare const call: (base: (browser: WindowBrowser, ...args: any[]) => any, ...thisarg: any[]) => any;
}
...
declare namespace $JSL {
     ...
     */
    declare function AttatchProperty(propertyval: any, propertyname: string, assertinto: object, err?: (err: Error) => void): void;
    /**
     * Memoize a function
     */
     ...
     */
    declare function AttatchasWindowModule(alias: string, factory: () => type, target: "Commonjs" | "ES6" = "Commonjs"): void;
    /**
     ...
     * 
     */
    type SuperDecorator = (fun: ScopedLibCallables, ...params: any[]) => ScopedLibCallables | ScopedLibCallables;
    declare function Wraps<ReturnType>(decorator: SuperDecorator, fun: ScopedLibCallables
        , ...argv: any[]): (...params: any) => ReturnType;
    /**
    ...
    declare const type=(o:object):typeof o=>typeof o.type!="undefined"?o.type:typeof o
    /**
     * @typeonly
     * @readonly
    ...
    declare function JSLattr<key extends keyof KnownJSLattr>(key:key):KnownJSLattr[key]
    ...
    declare function SpecialForm<T,O>(obj:O,
        getitem:(target: T, p: string | symbol, receiver: object)=> T):typeof Proxy<O>

    declare function TypeConstruct<O extends {
        new:(...args)=>O,
        constructor(...args):O
    }>(obj:O):O
}
...
interface LibCallable extends Function implements ScopedLibCallables, Function {
    public __doc__: string,
    public __ref__: string,
    private __priv__?: any[],
}
interface ScopedLibCallables extends LibCallable implements Function {
    private __scope__: object,
    public __persisted_scope__: object
}
